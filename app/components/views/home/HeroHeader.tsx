  ...
  return (
    <div className="sm:max-w-screen-md flex flex-col font-sans text-center px-4 mx-auto gap-5">
      ...
      <p
        ...
        className="text-slate-300/90 text-base lg:text-lg tracking-wide font-normal leading-[1.85]"
      >
      ...
      <div className="flex flex-row items-center justify-center gap-5 z-30">
        <LinkButton
          ...
          toHref="/download"
          variant="fill"
          className="duration-300 transition-all hover:[transform:translateY(-0.3rem)]"
        >
